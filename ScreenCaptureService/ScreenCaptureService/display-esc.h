// Windows display mirror device driver
// (C) Demoforge, 2003-2006
// developed by Lev Kazarkin (leo@demoforge.com)

// Windows display mirror device driver
// developed by Lev Kazarkin (aka leo)
...
enum
{
	DMF_ESCAPE_BASE_1	= 1030,
	DMF_ESCAPE_BASE_2	= 1026,
};
...
struct	CHANGES_BUF
{
// если бы ту?бы?элементарный размер ?
// информац? ?версии интерфейса,
// можн?было бы добавить информацию ?формат?экрана
	ULONG	counter;
